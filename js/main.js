document.addEventListener('DOMContentLoaded', function() {
  ...
  // Function to update language on all elements (except the toggle button)
  ...
  modalOverlays.forEach(overlay => {
    overlay.addEventListener('click', function(e) {
      if (e.target === overlay) {
        ...
        console.log("Closed modal by clicking outside content.");
      }
    });
  ...
  if (servicesToggle && mobileServicesMenu) {
    ...
    console.warn("Mobile services toggle elements not found.");
  }
